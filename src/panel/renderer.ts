export function renderJsonAsHtml(json: any): string {
  return renderNode('', json);
}

function renderNode(key: string, value: any): string {
...
function renderObject(key: string, obj: any): string {
...
function renderArray(key: string, arr: any[]): string {
  if (arr.length === 0) {
